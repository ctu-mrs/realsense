...
# Note: Run the script find_realsenses.sh to find the RealSense serial numbers
serial_no_camera1 = LaunchConfiguration("serial_no_camera1")
serial_no_camera2 = LaunchConfiguration("serial_no_camera2")

cam_1_namespace = LaunchConfiguration('cam_1_namespace')
cam_2_namespace = LaunchConfiguration('cam_2_namespace')
...
def generate_launch_description():
    ...
    return LaunchDescription([
        DeclareLaunchArgument('custom_config',       default_value=PathJoinSubstitution([
                                                                        FindPackageShare('mrs_realsense'),
                                                                        'config',
                                                                        'custom_config_2.yaml'
                                                                    ])),

        DeclareLaunchArgument('uav_name',            default_value=os.environ["UAV_NAME"]),
        DeclareLaunchArgument('serial_no_camera1',   default_value=f"\'{os.environ["REALSENSE_SERIAL_NUM0"]}\'"),
        DeclareLaunchArgument('serial_no_camera2',   default_value=f"\'{os.environ["REALSENSE_SERIAL_NUM1"]}\'"),
        DeclareLaunchArgument('cam_1_namespace',       default_value="up_rgbd"),
        DeclareLaunchArgument('cam_2_namespace',       default_value="down_rgbd"),
